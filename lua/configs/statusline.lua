    ...
    sections = {
        ...
        lualine_c = {
            ...
            },
            {
                ...
                diff_color = {
                    added = { fg = gray, gui = 'bold' },
                    modified = { fg = gray, gui = 'bold' },
                    removed = { fg = gray, gui = 'bold' },
                },
            },
        },
        lualine_x = {
            {
                ...
                diagnostics_color = {
                    error = { fg=error, gui='bold'  },
                    warn =  { fg=warn, gui='bold'   },
                    info =  { fg=info, gui='bold'   },
                    hint =  { fg=hint, gui='bold'   },
                },
                colored = true,
            },
        },
